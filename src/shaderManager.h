...
class ShaderManager
{
    public:
        ...
        static GLuint shaderFromFile(
                char const * const * vertShaderPath, 
                char const * const * fragShaderPath, 
                int const vertShaderCount, 
                int const fragShaderCount
                )
        {
            return readAndBuildProgram(vertShaderPath, fragShaderPath, vertShaderCount, fragShaderCount);
        }

        static GLuint shaderFromString(
                char const * const * vertShaderSource, 
                char const * const * fragShaderSource, 
                int const vertShaderCount, 
                int const fragShaderCount
                )
        {
    ...
    private:
        static GLuint readAndBuildProgram(
                char const * const * vertShaderPath, 
                char const * const * fragShaderPath, 
                int const vertShaderCount, 
                int const fragShaderCount
...
#define MAX_PATH_SIZE 800
        ...
        static GLuint createShaderProgram(
                char const * const * vertSource, 
                char const * const * fragSource, 
                char const * const * vertShaderPath, 
                char const * const * fragShaderPath, 
                int const vertShaderCount, 
                int const fragShaderCount
